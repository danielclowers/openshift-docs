...
[role="_abstract"]
To monitor the status of a {CNVOperatorDisplayName} update, watch the cluster service version (CSV) `PHASE`. You can also monitor the CSV conditions in the web console or by running the command provided here.
