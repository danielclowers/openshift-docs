...
[role="_abstract"]
You can use the web console to change the update channel and approval strategy for the {CNVOperatorDisplayName} subscription to control how and when updates are installed.
