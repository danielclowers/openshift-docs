...
//CNV-40183 Release note: Tech preview for storage class migration is now GA
* Storage class migration for running and stopped VMs is now generally available.
