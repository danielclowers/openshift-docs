...
Release notes for additional related components and products not included in the core xref:../release_notes/ocp-4-22-release-notes.adoc#ocp-4-22-release-notes[{product-title} {product-version} release notes] are available in the following documentation.
